...
<link rel="stylesheet" href="styles/cases-modal-style.css">


<!-- ADD MODAL -->
<dialog id="modal3" class="modal add-modal">
  ...
  <!-- UPDATE MODAL -->
<dialog id="modal4" class="modal update-modal">
  <div class="modal-content">
    <div class="header modal-header">
  ...
  <!-- REMOVE MODAL -->
<dialog id="modal5" class="modal remove-modal">
